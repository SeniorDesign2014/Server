...
// Modified for Google App Engine
func (twilio *Twilio) SendSMS(from, to, body, statusCallback, applicationSid string, c appengine.Context) (*SmsResponse, *Exception, error) {
	...
	// Modified for Google App Engine - passes c context
	res, err := twilio.post(formValues, twilioUrl, c)
	if err != nil {
